...
export default function AdminUsers() {
  ...
  return (
    <div className="admin-container d-flex">
      <aside className="admin-aside bg-light p-3">
        <h5>Admin menü</h5>
        <ul className="list-group">
          <li className="list-group-item">Értesítések</li>
          <li className="list-group-item">Profil és biztonság</li>
        </ul>
        <hr />
        <button className="btn btn-secondary d-md-none mt-2">Bezár</button>
      </aside>
        ...
        <div className="table-responsive card">
          <table className="table mb-0">
            <thead className="table-light">
              <tr>
                <th scope="col">
                  <input type="checkbox" aria-label="Összes kiválasztása" />
                </th>
                <th scope="col">Név</th>
